...
class JCachePage extends JCache
{
		...
		var $_id = '';
		var $_group	= '';
/*string*/	var $_uri = null;
/*string*/	var $_data = '';
/*string*/	var $_option = '';
/*string*/	var $_cache_filename = null;
/*int*/	var $_cache_modified = 0;
/*int*/	var $_content_modified = 0;
/*string*/	var $_content = null;
...
/*string*/	var $_hash = null;
	...
	// {
		...
		// if($option=='com_frontpage')
			// $option='com_content';
		// if($dh=@opendir($GLOBALS['mosConfig_cachepath']))
		// {
			// while(($file=readdir($dh))!==false)
				// if(substr($file,0,5)=='page_'.$option.'_')
					// touch($GLOBALS['mosConfig_cachepath'].'/'.$file,0);
			// closedir($dh);
		// }
	// }
	// function clearall()
	...
	// {
		...
		// {
			// while(($file=readdir($dh))!==false)
				// if(substr($file,0,5)=='page_')
					// unlink($GLOBALS['mosConfig_cachepath'].'/'.$file);
			// closedir($dh);
		// }
	// }
