(function($) {
	...
	$.fn.draw = function(o,obj,selectedpage){
		...
		if(o.rotate){
			...
			else var _rotleft	= $(document.createElement('span')).addClass(spreviousclass).html('&larr;');		
		}
		...
		if(o.rotate){
			...
			else var _rotright	= $(document.createElement('span')).addClass(snextclass).html('&rarr;');
		}
