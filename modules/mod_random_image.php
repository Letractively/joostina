...
if(!count($pics)){
?>
<div id="<?php echo $slideshow_name;?>" class="error">Проверьте настройки модуля mod_random_image и наличие изображений в указанном в настройках каталоге</div>
<?php
}else{
$pics_str = implode(',', $pics);
/* подлючаем расширение Jquery - simplegallery с выводом срипта в текущую позицию */
