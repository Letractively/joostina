...
*/
// doctorgrif: удалил лишние пробелы и табы, добавил языковые переменные, исправил теги на валидные
...
DEFINE('_CANNOT_RENAME_MAINMENU','Вы не можете переименовать меню \\\'mainmenu\\\', т.к.  это нарушит правильное функционирование Joomla');
