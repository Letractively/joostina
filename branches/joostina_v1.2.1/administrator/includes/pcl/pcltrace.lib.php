...
echo "<tr bgcolor=#00C>";
echo "<td bgcolor=#00C width=1>";
echo "</td>";
echo "<td><div align=center><font size=3 color=#FFF face=$v_font>Trace</font></div></td>";
echo "</tr>";
echo "<tr>";
echo "<td bgcolor=#00C width=1>";
echo "</td>";
...
echo "<td bgcolor=#00C width=1>";
echo "</td>";
echo "<td><div align=center><font color=#FFF face=$v_font>&nbsp</font></div></td>";
echo "</tr>";
echo "</table>";
}
