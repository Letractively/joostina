...
var html=name;
html = '<br /><img border="1" src="'+src+'" name="imagelib" alt="<?php echo _NO_PREVIEW?>" width="206px" height="145px" />';
...
<tr>
<th class="templates"><?php echo _TEMPLATES?> <small><small>[ <?php echo $client == 'admin'?_CONTROL_PANEL:_SITE; ?> ]</small></small></th>
...
<td align="left"><a href="#info" onmouseover="showInfo('<?php echo $row->name; ?>','<?php echo $row->directory; ?>')" onmouseout="return nd();"><?php echo $row->name; ?></a></td>
<?php
if($client == 'admin') {
?>
...
<tr>
<td width="290px"><table class="adminheading"><tr><th class="templates">HTML-редактор шаблона</th></tr></table></td>
<td width="220px" class="jtd_nowrap">
...
<td width="260px" class="jtd_nowrap">
