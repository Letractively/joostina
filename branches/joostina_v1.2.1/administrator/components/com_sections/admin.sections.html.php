...
<td colspan="2"><input class="text_area" type="text" name="title" value="<?php echo $row->title; ?>" size="50" maxlength="50" title="<?php echo _MENU_SHORT_NAME?>" /></td>
</tr>
<tr>
<td><?php echo _CMN_NAME?> <?php echo (isset($row->section)?_SECTION_NAME_OF_CATEGORY:_SECTION_NAME_OF_SECTION); ?>:</td>
<td colspan="2"><input class="text_area" type="text" name="name" value="<?php echo $row->name; ?>" size="50" maxlength="255" title="<?php echo _SECTION_NAME_TIP?>" /></td>
</tr>
<tr>
...
<strong><?php echo _SECTION_COPY_NAME?>:</strong><br />
<input class="text_area" type="text" name="title" value="" size="35" maxlength="50" title="<?php echo _SECTION_NAME?>" /><br /><br />
</td>
...
<strong><?php echo _CONTENT_ITEMS_TO_COPY?>:</strong><br />
<?php
echo "<ol>";
...
<td valign="top"><?php echo _SECTION_COPY_DESCRIPTION?></td>.
</tr>
</table>
<br /><br />
<input type="hidden" name="option" value="<?php echo $option; ?>" />
...
<tr>
<td><textarea style="width:100%;height:400px;" rows="40" cols="110" id="addcontent" name="addcontent"/></textarea></td>
</tr>
</tbody>
</table>
</td>
...
<label onclick="return sectionclick();" for="secid"><?php echo _SECTIONS?></label><br />
<input onclick="return catclick();" type="radio" class="inputbox" value="1" id="catid" name="type"/>
<label onclick="return catclick();" for="catid"><?php echo _CATEGORIES?></label><br />
...
<tbody>
<tr>
<th align="left"><?php echo _BUTTON_RESULTS; ?></th>
</tr>
<?php
$k = 0;
