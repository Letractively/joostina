...
<tr>
<th><?php echo _NEWSFEEDS_MANAGEMENT?></th>
<td width="right"><?php echo $lists['category']; ?></td>
</tr>
</table>
...
<th class="title" width="20%"><?php echo _E_CATEGORY?></th>
...
<td width="10%" align="center"><a href="javascript: void(0);" onclick="return listItemTask('cb<?php echo $i; ?>','<?php echo $task; ?>')"><img src="images/<?php echo $img; ?>" alt="<?php echo $alt; ?>" /></a></td>
...
<table class="adminheading">
<tr>
<th class="edit"><?php echo _NEWSFEED_TITLE?>: <small><?php echo $row->id?_O_EDITING:_O_CREATION; ?></small> <small><small>[ <?php echo $row->name; ?> ]</small></small></th>
</tr>
</table>
<table class="adminform">
<tr>
