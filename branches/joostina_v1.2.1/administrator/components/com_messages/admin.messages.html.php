...
<th width="20%" class="title"><?php echo _MAIL_FROM?>
</th>
<th width="15%" class="title"><?php echo _DATE?></th>
<th width="10%" class="title">Статус</th>
</tr>
<?php
$k = 0;
...
<td width="50%"><a href="#edit" onClick="hideMainMenu();return listItemTask('cb<?php echo $i; ?>','view')"><?php echo $row->subject; ?></a></td>
...
<td width="85%" bgcolor="#fff"><?php echo $row->user_from; ?></td>
</tr>
<tr>
<td><?php echo _MESSAGE_SEND_DATE?>:</td>
<td bgcolor="#fff"><?php echo $row->date_time; ?></td>
</tr>
<tr>
<td><?php echo _MAIL_SUBJECT?>:</td>
<td bgcolor="#fff"><?php echo htmlspecialchars($row->subject,ENT_QUOTES); ?></td>
</tr>
<tr>
<td valign="top"><?php echo _MESSAGE?>:</td>
<td width="100%" bgcolor="#fff"><pre><?php echo htmlspecialchars($row->message,ENT_QUOTES); ?></pre></td>
</tr>
</table>
<input type="hidden" name="option" value="<?php echo $option; ?>" />
<input type="hidden" name="task" value="" />
...
<input type="hidden" name="subject" value="<?php echo (substr($row->subject,0,
4) != 'Re: '?'Re: ':'').htmlspecialchars($row->subject,ENT_QUOTES); ?>" />
<input type="hidden" name="hidemainmenu" value="0" />
<input type="hidden" name="<?php echo josSpoofValue(); ?>" value="1" />
</form>
<?php
...
<tr>
<td><?php echo _MAIL_SUBJECT?>:</td>
<td><input type="text" name="subject" size="50" maxlength="100" class="inputbox" value="<?php echo htmlspecialchars($subject,ENT_QUOTES); ?>"/></td>
</tr>
<tr>
<td valign="top">Сообщение:</td>
<td width="100%"><textarea name="message" style="width:100%" rows="30" class="inputbox"></textarea></td>
</tr>
</table> 
