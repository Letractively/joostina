...
/** Get all content items within a content category. Returns an array of all contained content items. */
...
/** Get all Categories within a Section. Also call getCategory() for each Category to include it's items */
