...
<img src="<?php echo $mosConfig_live_site; ?>/images/M_images/new.png" width="13" height="14" align="middle" alt="<?php echo _CMN_NEW; ?>" />&nbsp;<?php echo _CMN_NEW; ?>...</a><br /><br />
<?php
}
?>
</td>
...
//doctorgrif: поправил вывод даты модификации
...
//doctorgrif: убрал вывод даты модификации, переместил в ячейку intro
HTML_content::ModifiedDate($row,$params);
*/
...
//doctorgrif: добавил h2 для заголовка
...
<img src="./images/M_images/edit.png" width="16" height="16" align="absmiddle" alt="<?php echo _E_EDIT;?>" /></a>
<?php
}
/** Writes Edit icon that links to edit page*/
...
//doctorgrif: изменен вывод доп. информации для отображения в одну строку, завешал все на span, чтоб избавится от таблицы, оригинал закомментировал. // надо добавить в css шаблона, дабы заработало, следующее:
//.addinfo{weight:100%;}
...
$create_date = null; if(intval($row->created) != 0) { 
...
$mod_date = null; if(intval($row->modified) != 0) {
...
<!--<tr><td align="left" colspan="2"><a href="<?php echo $row->link_on; ?>" title="<?php echo $row->title; ?>" class="readon<?php echo $params->get('pageclass_sfx'); ?>"><?php echo $row->link_text; ?></a></td></tr>-->
<?php
}
}
}
...
<?php if($allow_img){ //Отключаем вкладку "Изображения" ?>
var temp = new Array;
