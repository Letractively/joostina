...
//Редактор значков
DEFINE('_JCE_LAYOUT_MSG','Здесь представлены кнопки только опубликованных Команд и Плагинов. Для установки нужного расположения кнопок, можете перетащить кнопки из одного ряда в другой, или просто поменять их местами в пределах одного ряда. Серая область представляет Интерфейс пользователя Редактора. Кнопки должны находиться в пределах этой области. Синие прямоугольники указывают границу каждого ряда.');
DEFINE('_JCE_LAYOUT_PLUGINS', 'Плагины Менеджера изображений (Image manager) и Менеджера изображений SE (Image manager SE) представлены одним значком с изображением картины, плагины AdvLink и AdvLink SE - в виде одного значка с изображением ссылки (звенья цепи), но одновременно может использоваться только один тип плагина.');
...
//Плагины
DEFINE('_JCE_PLUGIN_PLUGIN', 'Плагин');
DEFINE('_JCE_PLUGIN_PLUGCOM', 'Плагин/команда');
DEFINE('_JCE_PLUGIN_NAME', 'Название');
DEFINE('_JCE_PLUGIN_HEADING', 'Менеджер плагинов JCE');
DEFINE('_JCE_PLUGIN_FILTER', 'Фильтр');
DEFINE('_JCE_PLUGIN_ACCESS_LIST', 'Список доступа');
...
DEFINE('_JCE_PLUGIN_DETAILS', 'Детали плагина');
DEFINE('_JCE_PLUGIN_PARAMS', 'Параметры');
DEFINE('_JCE_PLUGIN_ELMS', 'Элементы');
//Инсталлятор плагинов
DEFINE('_JCE_PLUGINS_INSTALL_HEADING','Установка новых плагинов JCE');
DEFINE('_JCE_PLUGINS_INSTALL_MSG', 'Здесь показаны только те плагины, которые могут быть удалены. Плагины ядра не могут быть удалены.');
DEFINE('_JCE_PLUGIN_NONE', 'Установленные плагины отсутствуют');
?>
