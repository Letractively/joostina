...
class XmapAdminHtml {
	...
	function show ( &$config, &$menus, &$pageNav, &$lists ) {
		...
		var ajaxURL = '<?php echo $xmapAdministratorURL . '/index2.php?option=com_xmap&task=ajax_request&no_html=1' ?>';
...
?>
		<form action="index2.php" method="post" name="adminForm" class="adminForm" onsubmit="document.adminForm.csscontent.value=codearea.getCode();document.adminForm.submit();">
<?php
...
?>
		...
		<table class="adminform">
			<tr>
				<th><a href="#" onclick="codearea.toggleEditor();return false;">Изменить редактор</a> <?php echo $template_path; ?></th>
			</tr>
			<tr>
				<td>
					<textarea style="width:100%;height:600px" cols="130" rows="35" name="codearea" id="codearea" class="codepress css inputbox"><?php echo $csscontent; ?></textarea>
				</td>
			</tr>
		</table>
		<input type="hidden" name="csscontent" value="" />
...
?>
		...
		<div id="sitemap<?php echo $sitemap->id; ?>" class="sitemap">
			...
			<div id="menulist<?php echo $sitemap->id; ?>" class="menulist">
			<?php
