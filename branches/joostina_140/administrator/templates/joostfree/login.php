...
?>
    ...
    <body>
        <div id="joo">
            <img src="<?php echo JPATH_SITE.'/'.JADMIN_BASE  ?>/templates/joostfree/images/logo_130.png" alt="Joostina!" />
        </div>
        <?php include_once (JPATH_BASE_ADMIN.DS.'modules'.DS.'mod_mosmsg.php'); ?>
