...
function print_table($dir, $list, $allow) {	// print table of files
	...
	// permissions
		...
		if($allow && $is_deletable) {
			...
			echo "<img border=\"0\" width=\"22\" height=\"22\" ";
			echo "src=\""._QUIXPLORER_URL."/images/_rename.png\" alt=\"".$GLOBALS["messages"]["renamelink"]."\" title=\"";
			echo $GLOBALS["messages"]["renamelink"]."\" /></a>\n";
		} 
		else {
			echo "<img border=\"0\" width=\"22\" height=\"22\" ";
			echo "src=\""._QUIXPLORER_URL."/images/_rename_.png\" alt=\"".$GLOBALS["messages"]["renamelink"]."\" title=\"";
		...
		if( get_is_editable($abs_item) && $GLOBALS['jx_File']->is_readable( $abs_item ) && get_is_file( $abs_item)) {
			...
			echo "<img border=\"0\" width=\"22\" height=\"22\" ";
			echo "src=\""._QUIXPLORER_URL."/images/src.png\" alt=\"".$GLOBALS["messages"]["viewlink"]."\" /></a>\n";
		}
		// DOWNLOAD / Extract
		...
		if(get_is_file( $abs_item)) {
			if($allow && $GLOBALS['jx_File']->is_deletable( $abs_item )) {
				...
				echo "<img border=\"0\" width=\"22\" height=\"22\" ";
				echo "src=\""._QUIXPLORER_URL."/images/_delete.png\" alt=\"".$GLOBALS["messages"]["dellink"];
				echo "\" title=\"".$GLOBALS["messages"]["dellink"]."\" /></a>\n";
			} 
			else {
				echo "<img border=\"0\" width=\"22\" height=\"22\" ";
				echo "src=\""._QUIXPLORER_URL."/images/_delete_.png\" alt=\"".$GLOBALS["messages"]["dellink"];
...
function list_dir($dir) {			// list directory contents
	...
	echo "<img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/_home.png\" ";
	...
	echo "align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/_refresh.png\" alt=\"".$GLOBALS["messages"]["reloadlink"];
	echo "\" title=\"".$GLOBALS["messages"]["reloadlink"]."\"></A></td>\n";
	// SEARCH
	if( !jx_isFTPMode() ) {
		echo "<td><a href=\"".make_link("search",$dir,NULL)."\">";
		echo "<img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/_search.png\" ";
	...
	echo "<img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/systeminfo.png\" ";
	...
	if($allow) {
		...
		echo "align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/_copy.png\" alt=\"".$GLOBALS["messages"]["copylink"];
		echo "\" title=\"".$GLOBALS["messages"]["copylink"]."\"></a></td>\n";
		// MOVE
		echo "<td><a href=\"javascript:Move();\"><img border=\"0\" width=\"22\" height=\"22\" ";
		echo "align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/_move.png\" alt=\"".$GLOBALS["messages"]["movelink"];
		echo "\" title=\"".$GLOBALS["messages"]["movelink"]."\"></A></td>\n";
		// DELETE
		echo "<td><a href=\"javascript:Delete();\"><img border=\"0\" width=\"22\" height=\"22\" ";
		echo "align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/_delete.png\" alt=\"".$GLOBALS["messages"]["dellink"];
		echo "\" title=\"".$GLOBALS["messages"]["dellink"]."\"></A></td>\n";
		// CHMOD
		echo "<td><a href=\"javascript:Chmod();\"><img border=\"0\" width=\"22\" height=\"22\" ";
		echo "align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/_chmod.png\" alt=\"chmod\" title=\"" . $GLOBALS['messages']['chmodlink'] . "\"></a></td>\n";
		// UPLOAD
		if(ini_get("file_uploads")) {
			echo "<td><a href=\"".make_link("upload",$dir,NULL)."\">";
			echo "<img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" ";
			echo "src=\""._QUIXPLORER_URL."/images/_upload.png\" alt=\"".$GLOBALS["messages"]["uploadlink"];
			echo "\" title=\"".$GLOBALS["messages"]["uploadlink"]."\"></A></td>\n";
		} else {
			echo "<td><img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" ";
			echo "src=\""._QUIXPLORER_URL."/images/_upload_.png\" alt=\"".$GLOBALS["messages"]["uploadlink"];
		...
		if( ($GLOBALS["zip"] || $GLOBALS["tar"] || $GLOBALS["tgz"]) && !jx_isFTPMode() ) {
			...
			echo "align=\"absmiddle\" src=\""._QUIXPLORER_URL."/images/_archive.png\" alt=\"".$GLOBALS["messages"]["comprlink"];
			echo "\" title=\"".$GLOBALS["messages"]["comprlink"]."\"></a></td>\n";
		}
	} else {
		// COPY
		echo "<td><img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" ";
		echo "src=\""._QUIXPLORER_URL."/images/_copy_.png\" alt=\"".$GLOBALS["messages"]["copylink"]."\" title=\"";
		echo $GLOBALS["messages"]["copylink"]."\"></td>\n";
		// MOVE
		echo "<td><img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" ";
		echo "src=\""._QUIXPLORER_URL."/images/_move_.png\" alt=\"".$GLOBALS["messages"]["movelink"]."\" title=\"";
		echo $GLOBALS["messages"]["movelink"]."\"></td>\n";
		// DELETE
		echo "<td><img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" ";
		echo "src=\""._QUIXPLORER_URL."/images/_delete_.png\" alt=\"".$GLOBALS["messages"]["dellink"]."\" title=\"";
		echo $GLOBALS["messages"]["dellink"]."\"></td>\n";
		// UPLOAD
		echo "<td><img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" ";
		echo "src=\""._QUIXPLORER_URL."/images/_upload_.png\" alt=\"".$GLOBALS["messages"]["uplink"];
	...
	if($GLOBALS["require_login"]) {
		...
		if($admin) {
			...
			echo "<img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" ";
			echo "src=\""._QUIXPLORER_URL."/images/_admin.png\" alt=\"".$GLOBALS["messages"]["adminlink"]."\" title=\"";
			echo $GLOBALS["messages"]["adminlink"]."\"></A></td>\n";
		}
		// LOGOUT
		echo "<td><a href=\"".make_link("logout",NULL,NULL)."\">";
		echo "<img border=\"0\" width=\"22\" height=\"22\" align=\"absmiddle\" ";
		echo "src=\""._QUIXPLORER_URL."/images/_logout.png\" alt=\"".$GLOBALS["messages"]["logoutlink"]."\" title=\"";
