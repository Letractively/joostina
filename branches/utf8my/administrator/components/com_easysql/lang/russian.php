...
define('_ES_TOCSV',				'Экспорт в CSV');
define('_ES_COPYRIGHT',			'<br/><center>Компонент <a href="http://lurm.net/?other/easysql">EasySQL v.1.2</a> для Joomla. Автор: <a href="http://serebro.tarelka.net/">Serebro</a></center>');
