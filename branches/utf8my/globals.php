...
/**
 * Эмуляция регистрации глобальных переменных (Register Globals Emulation)
 * больше не настраивается в этом файле. Сейчас этот параметр настраивается в глобальной
 * конфигурации сайта, в админцентре.
 */
if( defined( 'RG_EMULATION' ) === false ) {
	...
	if( defined( 'RG_EMULATION' ) === false ) {
		// В The configuration file is old so default to on
