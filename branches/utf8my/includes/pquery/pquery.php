...
class JQuery  {
	...
	function link_to_remote($name,$options=null,$html_options=null,$title="")
	{
		$html_options['id'] = isset($options['id'])?$options['id']:$this->_random_id();
		return $this->link_to_function($name,$this->remote_function($options),$html_options,$title);
	}
	...
	function link_to_function($name,$function,$html_options=null,$title="")
	{
		$uid=(isset($html_options['id']))?$html_options['id']:$this->_random_id();
		$id_string = 'id="'.$uid.'"';
		return '<a title="'.$title.'" href="'.((isset($html_options['href']))?$html_options['href']:'#').'" onclick=\''.((isset($html_options['onclick']))?$html_options['onclick'].';':'').$function.'; return false;\'>'.$name.'</a>';
