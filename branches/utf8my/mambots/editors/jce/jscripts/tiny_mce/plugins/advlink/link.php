		...
		<div id="general_panel" class="panel current">
			<fieldset>
				...
				<table border="0" cellpadding="4" cellspacing="0">
					<tr>
						<td class="jtd_nowrap"><label id="hreflabel" for="href"><?php echo $jce->translate('url');?></label></td>
						<td>
					...
					<tr>
						<td class="jtd_nowrap"><label id="titlelabel" for="title"><?php echo $jce->translate('title');?></label></td>
