...
<div class="step-off"><img src="img/img-1.png" alt="Установка Joostina" /></div>
</div>
<div id="right">
<div class="clr"></div>
...
<td align="left"><?php echo phpversion() < '4.1'?'<b><font color="red">Нет</font></b>':'<b><font color="green">Да</font></b>'; ?></td>
</tr>
<tr>
<td>&nbsp; - поддержка zlib-сжатия</td>
<td align="left"><?php echo extension_loaded('zlib')?'<b><font color="green">Доступна</font></b>':'<b><font color="red">Недоступна</font></b>'; ?></td>
</tr>
<tr><td>&nbsp; - поддержка XML</td>
<td align="left"><?php echo extension_loaded('xml')?'<b><font color="green">Доступна</font></b>':'<b><font color="red">Недоступна</font></b>'; ?></td>
</tr>
<tr><td>&nbsp; - поддержка MySQL</td>
<td align="left"><?php echo function_exists('mysql_connect')?'<b><font color="green">Доступна</font></b>':'<b><font color="red">Недоступна</font></b>'; ?></td>
</tr>
<tr>
...
<tr>
<td class="item" colspan="2"><b><?php echo $sp?$sp:'Не установлен'; ?></b></td>
</tr>
</table>
</div>
</div>
...
<div class="install-text"><p>Следующие параметры PHP являются неоптимальными для <strong>Безопасности</strong> и их рекомендуется изменить:</p><p>Пожалуйста, за дополнительной информацией обращайтесь на <a href="http://forum.joomla.org/index.php/topic,81058.0.html" target="_blank">официальный форум Joomla! - темы о Безопасности</a>.</p>
<div class="ctr"></div>
</div>
<div class="install-form">
...
&nbsp;&nbsp;Эти параметры PHP рекомендуются для полной совместимости с Joostina.<br />Однако, Joostina будет работать, если эти параметры не в полной мере соответствуют рекомендуемым.
<div class="ctr"></div>
</div>
<div class="install-form">
<div class="form-block">
