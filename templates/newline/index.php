...
<div class="valid">
<a href="http://jigsaw.w3.org/css-validator/validator?uri=<?php echo $mosConfig_live_site;?>" target="_blank" title="CSS Validity" style="text-decoration:none;"><img src="<?php echo $mosConfig_live_site;?>/templates/<?php echo $mainframe->getTemplate(); ?>/images/w3c_css.png" alt="CSS Validity" /></a>
<a href="http://validator.w3.org/check/referer" target="_blank" title="XHTML Validity" style="text-decoration:none;"><img src="<?php echo $mosConfig_live_site;?>/templates/<?php echo $mainframe->getTemplate(); ?>/images/w3c_xhtml.png" alt="XHTML Validity" /></a>
</div>
</div>
<!--footer:end-->
</div>
...
<!--
$(document).ready(function(){$('div.moduletable-round').corner();$('div.block2 h3').corner();});
//-->
</script>
<!--body:end-->
</body>
