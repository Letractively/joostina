...
DEFINE('_LOCALE_WINDOWS','Выберите из списка более подходящую для сайта');
...
DEFINE('_MENU_NEW_SITE_TEMPLATE','Управление шаблонами');
...
DEFINE('_COMPONENTS_INSTALL_UNINSTALL','Управление компонентами');
...
DEFINE('_COM_CONFIG_CC_TYPE_USERNAME','Тип вывода имени пользователя');
DEFINE('_COM_CONFIG_CC_TYPE_USERNAME_HELP','Выберите тип отображения имени автора публикации');
