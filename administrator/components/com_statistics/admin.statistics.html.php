...
<td align="left">&nbsp;<?php echo $row->title." (".$row->created.")"; ?>&nbsp;</td>
...
<table cellpadding="4" cellspacing="0" border="0" width="100%" class="adminheading">
<tr>
<th class="searchtext"><?php echo _SEARCH_QUERIES?>:<span class="componentheading"><?php echo _LOG_SEARCH_QUERIES?>:<?php echo $mainframe->getCfg('enable_log_searches')?'<b><font color="green">'._ALLOWED.'</font></b>':'<b><font color="red">'._DISALLOWED.'</font></b>' ?></span></th>
<td align="right">
<?php
if(!$showResults) {
