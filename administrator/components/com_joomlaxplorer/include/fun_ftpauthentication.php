...
function ftp_authentication( $ftp_login='', $ftp_pass='') {
	...
	<form name="ftp_auth_form" method="post" action="<?php echo $mosConfig_live_site ?>/<?php echo ADMINISTRATOR_DIRECTORY?>/index3.php" onsubmit="return checkFTPAuth('<?php echo $mosConfig_live_site ?>/<?php echo ADMINISTRATOR_DIRECTORY?>/index3.php');" id="adminform">
