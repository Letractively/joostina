...
<tr>
<th><?php echo _WEBLINKS_MANAGEMENT?></th>
...
<th class="title"><?php echo _E_CAPTION?></th>
<th width="5%"><?php echo _ON_SITE?></th>
<th colspan="2" width="5%"><?php echo _CMN_ORDERING?></th>
<th width="25%" align="left"><?php echo _E_CATEGORY?></th>
<th width="5%"><?php echo _WEBLINKS_HITS?></th>
</tr>
<?php
$k = 0;
...
?>
<a href="<?php echo $link; ?>" title="<?php echo _CHANGE_WEBLINK?>"><?php echo $row->title; ?></a>
<?php
}
?>
</td>
...
<td><a href="<?php echo $row->cat_link; ?>" title="<?php echo _CHANGE_CATEGORY?>"><?php echo $row->category; ?></a></td>
...
<table class="adminheading">
<tr>
<th><?php echo _WEBLINK_URL?>: <small><?php echo $row->id?_O_EDITING:_O_CREATION; ?></small></th>
</tr>
</table>
<table width="100%">
<tr>
...
<tr>
<td width="30%" align="right"><?php echo _WEBLINK_NAME?>:</td>
<td width="70%"><input class="text_area" type="text" name="title" size="50" maxlength="250" value="<?php echo $row->title; ?>" /></td>
</tr>
<tr>
...
<td><input class="text_area" type="text" name="url" value="<?php echo $row->url; ?>" size="50" maxlength="250" /></td>
</tr>
<tr>
<td valign="top" align="right"><?php echo _CMN_DESCRIPTION?>:</td>
<td><textarea class="text_area" cols="50" rows="5" name="description" style="width:500px" width="500"><?php echo $row->description; ?></textarea></td>
</tr>
<tr>
<td valign="top" align="right"><?php echo _SORT_ORDER?>:</td>
