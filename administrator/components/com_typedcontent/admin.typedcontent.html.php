...
if($times) {
?>
<td align="center" <?php echo ($row->checked_out && ($row->checked_out != $my->id))?null:'onclick="ch_publ('.$row->id.',\'com_typedcontent\');" class="td-state"'; ?>><img class="img-mini-state" src="images/<?php echo $img; ?>" id="img-pub-<?php echo $row->id; ?>" alt="<?php echo _E_PUBLISHING?>" /></td>
<?php
}
?>
...
<img name="view_imagefiles" src="../images/M_images/blank.png" width="100px" />
</div>
</td>
<td valign="top">
<div align="center">
<?php echo _ACTIVE_IMAGE?>:<br />
<img name="view_imagelist" src="../images/M_images/blank.png" width="100px" />
</div>
</td>
</tr>
<tr>
