...
<td align="left"><input class="inputbox" type="text" name="text" size="50" maxlength="100" value="<?php echo $row->text; ?>" /></td>
</tr>
<tr>
<td align="right"><?php echo _BUTTON_TITLE?>:</td>
<td align="left"><input class="inputbox" type="text" name="title" size="50" maxlength="64" value="<?php echo $row->title; ?>" />
<?php
...
<td align="left"><input type="checkbox" name="new_window" value="1" id="new_window"<?php echo $row->new_window ? ' checked="checked"':''; ?> />
<?php
...
<div class="cpicons"><a href="javascript:void(0);" onclick="<?php echo $js_action; ?>;"><img src="<?php echo $image; ?>" alt="<?php echo $image; ?>" title="<?php echo $image; ?>" /></a></div>
</div>
<?php
}
...
<tr>
<th>
<div><a href="#" onclick="window.close()"><?php echo _CLOSE?></a></div>
</th>
</tr>
<tr>
