                ...
                <table class="adminlist" width="100%">
                    ...
                    <tbody>
                        ...
                        for ($i = 0, $n = $_c; $i < $n; $i++) {
                            ...
                            $front_img =  $cur_file_icons_path.'/'.$front_img;
                        ...
                        <tr class="row<?php echo $k; ?>" id="tr-el-<?php echo $row->id;?>">
                            ...
                            <td align="center" class="td-state">
                                ...
                                ?>
                            <td align="center" class="td-state">
                                <img class="img-mini-state" src="<?php echo $front_img;?>" obj_id="<?php echo $row->id;?>" obj_task="frontpage" alt="<?php echo _ON_FRONTPAGE?>" title="<?php echo _ON_FRONTPAGE?>" />
                            </td>
