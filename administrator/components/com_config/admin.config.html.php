...
class HTML_config {
	function showconfig(&$row,&$lists,$option) {
		global $mosConfig_live_site,$mosConfig_session_type,$mainframe;
...
<table width="100%">
	<tr>
		...
		<table class="sub_adminform">
			...
			<tr>
				<td><?php echo mosToolTip(_LINK_TITLES2,'','','',_ITEMID_COMPAT)?>:</td>
...
<table width="100%">
		...
		<tr>
			...
			<td><?php echo $lists['captcha'];echo mosToolTip(_ADMIN_CAPTCHA2); ?></td>
		</tr>
		<tr>
