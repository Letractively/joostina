...
if($unread) {
	echo "<a class=\"adminmail\" href=\"index2.php?option=com_messages\" style=\"color: red; text-decoration: none;  font-weight: bold\"><img  src=\"images/mail.png\" align=\"top\" border=\"0\" alt=\"Почта\" /> $unread </a>";
} else {
