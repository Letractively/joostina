...
if($mosConfig_gz_js_css) { // работа со сжатыми css и js файлами
	$mainframe->addCSS($mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/templates/adminkus/css/joostfree_css.php');
	$mainframe->addJS($mosConfig_live_site.'/includes/js/joostina.admin.php');
} else { // использовать стандартные - не сжатые файлы
	$mainframe->addCSS($mosConfig_live_site.'/'.ADMINISTRATOR_DIRECTORY.'/templates/adminkus/css/template_css.css');
...
<link rel="shortcut icon" href="<?php echo $mosConfig_live_site; ?>/images/favicon.ico" />
	...
	<div class="page">
		<div id="topper">
			<div id="wrapper">         
				<div id="joo">
					<a class="logo" href="index2.php" title="<?php echo _GO_TO_MAIN_ADMIN_PAGE?>">
						<img border="0" alt="<?php echo _GO_TO_MAIN_ADMIN_PAGE?>" src="templates/adminkus/images/logo.png" />
					</a>
                    <div class="cms">Joostina CMS</div>
                    <div class="site_name"><h1><?php echo $mosConfig_sitename; ?></h1></div>
                    <small>время сервера: 21:31</small>
				</div>
                <div class="wrap_r"><div class="u_area">
                    <div class="joo_user">Здравствуйте, <a href="#"><?php echo $my->username; ?></a></div>
                    <div class="joo_mess"><a href="#">2 новых сообщения</a></div>
                    <a href="<?php echo $mosConfig_live_site; ?>" target="_blank" class="view_site"><?php echo _PREVIEW_SITE?></a>
                    <a href="index2.php?option=logout" class="logoff"><?PHP echo _BUTTON_LOGOUT?></a>
                </div></div>
			</div>
			...
			<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
				<tr class="menubackgr">
					<td style="padding-left: 7px;width: 15px;">
		...
		<table width="100%" class="menubar" cellpadding="0" cellspacing="0" border="0">
			<tr>
                <td align="left" valign="top" width="200" class="left_col"   id="togllcol"> <?php mosLoadAdminModules('left',0); ?>  </td>

	<td onclick="togllcoll();" width="1" class="tdtogleoff" id="tdtogle"><img border="0" alt="<?php echo _HIDE_NAV_TREE?>" src="images/tgl.gif" /></td>
...
<?php }?>
		...
		function togllcoll(){
			if(SRAX.get('togllcol').style.display =='none'){
				SRAX.get('togllcol').style.display ='table-cell';
            	SRAX.get('tdtogle').className='tdtogleoff';
				setCookie('j-ntree-hide','0');
			}else{
				SRAX.get('togllcol').style.display ='none';
				SRAX.get('tdtogle').className='tdtogleon';
