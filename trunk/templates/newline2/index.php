...
<!--[if lte IE 7]>
    <link href="<?php echo $mosConfig_live_site;?>/templates/<?php echo $mainframe->getTemplate(); ?>/css/fix/ie7.css" rel="stylesheet" type="text/css" />
<![endif]-->

<!--[if IE 8]><link href="<?php echo $mosConfig_live_site;?>/templates/<?php echo $mainframe->getTemplate(); ?>/css/fix/ie8.css" rel="stylesheet" type="text/css"/><![endif]-->
</head>
...
$mainframe->addJS($mainframe->getCfg('live_site').'/templates/'.$mainframe->getTemplate().'/js/corners.js', 'js');
