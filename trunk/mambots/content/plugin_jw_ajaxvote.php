...
function pluginJWAjaxVote(&$row,&$params) {
	...
	if($params->get('rating') && !$params->get('popup')) {
		...
		$script  = '<script type="text/javascript">var live_site = \''.JPATH_SITE.'\';var jwajaxvote_lang = new Array();jwajaxvote_lang[\'UPDATING\'] = \''._AV_UPDATING.'\';jwajaxvote_lang[\'THANKS\'] = \''.$thmess.'\';jwajaxvote_lang[\'ALREADY_VOTE\'] = \''._AV_ALREADY_VOTE.'\';jwajaxvote_lang[\'VOTES\'] = \''._AV_VOTES.'\';jwajaxvote_lang[\'VOTE\'] = \''._AV_VOTE.'\';</script>'."\n";
