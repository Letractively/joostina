...
function jceEditorInit() {
	...
	if( $params->get('size_all', '0') ) $allsize = "width : \"" . $editor_width . "\",height : \"" . $editor_height . "\","; else $allsize = '';
...
?>
<script type="text/javascript" src="<?php echo $base_url;?>/mambots/editors/jce/jscripts/tiny_mce/<?php echo $tiny_file;?>"></script>
<script type="text/javascript" src="<?php echo $base_url;?>/mambots/editors/jce/jscripts/tiny_mce/jce.functions.js"></script>
<?php echo $gzip_init;?>
