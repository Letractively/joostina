...
/*перемещено в russian/com_banners.php */
...
DEFINE('_AUTHOR_NAMES','Скрыть имена авторов');
...
DEFINE('_DATE_TIME_CREATION','Скрыть дату и время создания');
...
DEFINE('_DATE_TIME_MODIFICATION','Скрыть дату и время изменения');
...
DEFINE('_LINK_PRINT','Скрыть Ссылку Печать');
DEFINE('_LINK_EMAIL','Скрыть Ссылку E-mail');
...
DEFINE('_LOCALE_WINDOWS','При использовании в Windows необходимо ввести <span style="color: red"><strong>RU</strong></span>.<br />В Unix-системах, если не работает значение по умолчанию, можно попробовать изменить регистр символов локали на <strong>RU_RU.CP1251, ru_RU.cp1251, ru_ru.CP1251</strong>, или узнать значение русской локали у провайдера.<br />
...
DEFINE('_RG_EMULATION_ON_OFF','Параметр Joostina! RG_EMULATION в файле globals.php установлен в `ON` вместо `OFF`<br /><span style="font-weight: normal; font-style: italic; color: #666;">`ON` - параметр по умолчанию - для совместимости</span>');
