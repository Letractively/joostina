...
DEFINE('_MOD_FULLMENU_GLOBAL_CONFIG','Глобальная конфигурация');
DEFINE('_MOD_FULLMENU_GLOBAL_CONFIG_TIP','Настройка основных параметров конфигурации системы');
DEFINE('_MOD_FULLMENU_LANGUAGES','Языковые пакеты');
DEFINE('_MOD_FULLMENU_LANGUAGES_TIP','Управление языковыми файлами');
DEFINE('_MOD_FULLMENU_SITE_PREVIEW','Предпросмотр сайта');
DEFINE('_MOD_FULLMENU_SITE_PREVIEW_IN_NEW_WINDOW','В новом окне');
...
DEFINE('_MOD_FULLMENU_PAGE_STATS','Статистика посещения страниц');
DEFINE('_MOD_FULLMENU_TEMPLATES_TIP','Управление шаблонами');
DEFINE('_MOD_FULLMENU_SITE_TEMPLATES','Шаблоны сайта');
DEFINE('_MOD_FULLMENU_NEW_SITE_TEMPLATE','Управление шаблонами');
DEFINE('_MOD_FULLMENU_ADMIN_TEMPLATES','Шаблоны админцентра');
DEFINE('_MOD_FULLMENU_NEW_ADMIN_TEMPLATE','Установка нового шаблона');
DEFINE('_MOD_FULLMENU_MENU','Меню');
...
DEFINE('_MOD_FULLMENU_SITE_MODULES','Модули сайта');
DEFINE('_MOD_FULLMENU_ADMIN_MODULES','Модули панели управления');
