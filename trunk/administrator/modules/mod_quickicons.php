...
if(!defined('_QUICKICON_MODULE')) {
	...
	if($use_ext){
		...
		if(file_exists($mosConfig_absolute_path.DS.ADMINISTRATOR_DIRECTORY.'/templates/'.$cur_template.'/html/quickicons.php')) {
			require_once ($mosConfig_absolute_path.DS.ADMINISTRATOR_DIRECTORY.'/templates/'.$cur_template.'/html/quickicons.php');
		} else {
			// использование стандартных значков отображени€
			require_once ($mosConfig_absolute_path.DS.ADMINISTRATOR_DIRECTORY.'/components/com_quickicons/quickicons.php');
		}
	}else{
		// использование стандартных значков отображени€
		require_once ($mosConfig_absolute_path.DS.ADMINISTRATOR_DIRECTORY.'/components/com_quickicons/quickicons.php');
