...
<div class="mod_ml_login login vertical">
    <form action="<?php echo sefRelToAbs( 'index.php?option=com_users&task=login', true ); ?>" method="post" name="login">
		<div class="login_form">
			...
			<a href="<?php echo sefRelToAbs( 'index.php?option=com_users&amp;task=lostpassword', true );?>"><?php echo _LOST_PASSWORDWORD?></a>
			<a href="<?php echo sefRelToAbs( 'index.php?option=com_users&amp;task=register', true );?>"><?php echo _CREATE_ACCOUNT?></a>
		</div>
