...
function showItem( $uid, $gid, &$access, $pop, $option='com_content', $now ) {
	global $database, $mainframe, $Itemid,$mosConfig_disable_date_state,$mosConfig_disable_access_control;
...
function show( $row, $params, $gid, &$access, $pop, $option='com_content', $ItemidCount=NULL ) {
	...
	if ( $params->get( 'rating' ) ) {
		...
		if(!isset($voteLoad)){
			$query = "SELECT ROUND( rating_sum / rating_count ) AS rating, rating_count, content_id"
...
function _where( $type=1, &$access, &$noauth, $gid, $id, $now=NULL, $year=NULL, $month=NULL, $params=NULL ) {
	global $database, $mainframe,$mosConfig_session_front,$mosConfig_disable_date_state,$mosConfig_disable_access_control;
