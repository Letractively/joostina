...
if(!defined('_QUICKICON_MODULE')) {
	...
	if($use_ext){
		...
		if(file_exists($mosConfig_absolute_path.'/administrator/templates/'.$cur_template.'/html/quickicons.php')) {
			require_once ($mosConfig_absolute_path.'/administrator/templates/'.$cur_template.'/html/quickicons.php');
		} else {
			// использование стандартных значков отображени€
			require_once ($mosConfig_absolute_path.'/administrator/components/com_quickicons/quickicons.php');
		}
	}else{
		// использование стандартных значков отображени€
		require_once ($mosConfig_absolute_path.'/administrator/components/com_quickicons/quickicons.php');
