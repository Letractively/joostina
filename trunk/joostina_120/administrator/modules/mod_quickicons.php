...
if(!defined('_QUICKICON_MODULE')) {
	...
	if($use_ext){
		...
		if(file_exists($mosConfig_absolute_path.'/'.getAdminDirectoryName().'/templates/'.$cur_template.'/html/quickicons.php')) {
			require_once ($mosConfig_absolute_path.'/'.getAdminDirectoryName().'/templates/'.$cur_template.'/html/quickicons.php');
		} else {
			// использование стандартных значков отображени€
			require_once ($mosConfig_absolute_path.'/'.getAdminDirectoryName().'/components/com_quickicons/quickicons.php');
		}
	}else{
		// использование стандартных значков отображени€
		require_once ($mosConfig_absolute_path.'/'.getAdminDirectoryName().'/components/com_quickicons/quickicons.php');
