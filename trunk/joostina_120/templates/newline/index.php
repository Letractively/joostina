...
<body class="joo_flex">
        ...
        <div class="wrapper">
            ...
            <div class="header">
                ...
                <div class="header_right">
                    ...
                    <a title="Карта сайта" href="index.php?option=com_xmap&amp;Itemid=27" id="map" class="navbar">&nbsp;</a>
    ...
    <div class="footer">
        <div class="bottom">
            <a title="О проекте" href="http://www.joostina.ru" id="about" class="bottom_bar">&nbsp;</a>
